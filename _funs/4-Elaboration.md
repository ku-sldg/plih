...
## Exercises
1. Write the elaborator for pairs
2. Define `case` as a derived form using `if`.  You may use other language constructs if necessary
3. Define multi-argument functions as a derived form using currying.
